      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Everything you need to transform your business with technology.
          </p>
        </div>
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="px-8 py-10">
                ...
                <p className="text-gray-600 mb-8 text-lg">
                  Perfect for businesses ready to scale with comprehensive tech solutions.
                </p>
                ...
                <a
                  ...
                  className="block w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white text-center px-8 py-4 rounded-xl font-bold text-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
                  Get Started Now
                </a>
